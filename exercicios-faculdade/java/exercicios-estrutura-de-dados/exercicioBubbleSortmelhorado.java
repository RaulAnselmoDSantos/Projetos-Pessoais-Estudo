public class exercicioBubbleSortmelhorado{
    ...
    public static void main(String[] args) {
        ...
        inicio = System.currentTimeMillis();
        selectionSort(vet.clone(), N);
        fim = System.currentTimeMillis();
        System.out.println("Tempo algoritmo SelectionSort: " + (fim - inicio) + "ms"); 

    }

    static void selectionSort(int[] vet, int N) {
